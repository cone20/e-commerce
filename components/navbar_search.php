        ...
        <div class="container px-4 px-lg-5">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <div class="d-flex flex-column flex-lg-row gap-sm-3 gap-lg-5 text-center">
                    <a class="nav-link links" href="http://localhost/e-commerce/#login">Пријави се</a>
                    <a class="nav-link links" href="http://localhost/e-commerce/#register">Направи налог</a>
                </div>
                <?php
                    endif;
                ?>
