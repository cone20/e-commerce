        ...
        <header class="bg-dark py-5">
            <div class="container px-4 px-lg-5 my-5">
                <div class="text-center text-white">
                    <h1 class="display-4 fw-bolder">Најновији производи</h1>
                    <p class="lead fw-normal text-white-50 mb-0">Добродошли на званичну страницу е-продавнице</p>
                </div>
            </div>
        </header>
        <!-- Ovde samo izlistaj 6 knjige tek onako da ima sa forEach -->
        <!-- Section 1 -->
        <section class="py-5">
